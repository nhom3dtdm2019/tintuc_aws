                                ...
                                <div class="card">
                                    <div class="card-header">
                                     ...
                                     <div class="card-body card-block">
                                          <form method="post" action="save-update-trending?idtrend=${trend.idtrend}" enctype="multipart/form-data">
    <div class="form-group">
      <input type="hidden" class="form-control" name="idtrend" value="${trend.idtrend}">	
    </div>
    <div class="form-group">
      <input type="text" class="form-control" name="idtrend" value="${trend.idtrend}">
      <label >title:</label>
      <input type="text" class="form-control" name="trendname" value="${trend.trendname}">		
    </div>
    <div class="form-group">
      <label >image:</label>
      <input type="text" class="form-control" name="hinhanh" value="${trend.hinhanh}">
    </div>
    <div class="form-group">
      <label >Summary</label>
      <input type="text" class="form-control" name="tomtat" value="${trend.tomtat}">
    </div>
    <div class="form-group">
